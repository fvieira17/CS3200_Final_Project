...
class Login extends React.Component {
    ...
    render() {
        ...
        if (this.props.loginError) {
            error = <div style={{color:"red"}}> Username/password combination is incorrect</div>;
        }
        else if (this.props.registerError) {
            error = <div style={{color:"red"}}> An error occured while registering the user to the database </div>;
        }
        else if (this.props.regSuccess) {
            error = <div style={{color:"green"}}> Registration occured succesfully! </div>
        }
        else {
            error = <div></div>;
        }
